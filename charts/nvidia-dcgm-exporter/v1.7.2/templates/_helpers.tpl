...
{{ include "nvidia-dcgm-exporter.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "nvidia-dcgm-exporter.selectorLabels" -}}
...
*/}}
{{- define "nvidia-dcgm-exporter.serviceAccountName" -}}
{{- if .Values.serviceAccount.create -}}
    {{ default (include "nvidia-dcgm-exporter.fullname" .) .Values.serviceAccount.name }}
{{- else -}}
