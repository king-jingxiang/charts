...
*/}}
{{- define "nvidia-gpushare-device-plugin.fullname" -}}
...
*/}}
{{- define "nvidia-gpushare-device-plugin.serviceAccountName" -}}
{{- if .Values.serviceAccount.create -}}
    {{ default (include "nvidia-gpushare-device-plugin.fullname" .) .Values.serviceAccount.name }}
{{- else -}}
